                                ...
                                this.player.on("fullscreen", function () {
                                    ...
                                    this.player.template.webFullButton.addEventListener("click", (function() {
                                        ...
                                        if(e.player.container.classList.contains("dplayer-fulled")){
                                            e.player.template.webFullButton.querySelector(".dplayer-icon-content").innerHTML='<svg viewBox="0 0 18 18"><path style="fill:none!important"d="M14,2H4C2.897,2,2,2.897,2,4v10c0,1.103,0.897,2,2,2h10c1.103,0,2-0.897,2-2V4C16,2.897,15.103,2,14,2z\n' +
